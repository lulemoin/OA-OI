...
<div>
    <form action="/OA-OI_git/project-root/public/dashboard/create" method="post">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="user_profile" id="gridRadios2" value="option2">
                        <label class="form-check-label" for="gridRadios2">
                            Agence de développement
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="user_profile" id="gridRadios3" value="option3">
        ...
        <div class="form-row col-md-10">
            <label for="inputPassword3" class="col-sm-10 col-form-label">Confirmer le mot de passe</label>
            <div class="col-sm-10">
